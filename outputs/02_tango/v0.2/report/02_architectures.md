...
"multi-agent" does not say how the agents relate. Two rows left the `not stated` column in
v0.2 when their full text was recovered and read [[doi:10.1039/d5dd00435g]]
...
65 of 101 core systems — more often than planning, and in v0.2 it overtook role-specialisation
to become the third most common technique — which is consistent with what section 01
