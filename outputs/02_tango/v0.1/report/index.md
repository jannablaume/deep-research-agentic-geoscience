...
**Access.** This run originally demoted 15 records screened as core that it could not read in
full — 13% of the intended deep-read. Fourteen sources were later retrieved by hand from the
local PDF store: three of the demoted fifteen, all promoted back to core, leaving **12
demotions and 11% of the intended deep-read still lost**; and eleven already-core records that
had originally been read from a substitute. Of those eleven, 8 were verified unchanged against the version of record and 3 were
