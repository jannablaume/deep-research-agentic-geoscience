# Gap candidates — 326 extracted from 01_landscape/v0.5, 02_tango/v0.1
...
### c235
**00_executive_summary.md** — 02_tango/v0.1 · q007;q010

(backed by query cells `q007`-`q010`) No admitted source drives a full life-cycle cost model — levelised cost, discounted cash flow or equivalent — as the system it controls. Economic quantities appear as objectives inside optimisation loops, not as the driven artefact. The energy-systems and geoenergy cells (`q007`–`q010`) were harvested without a paging cap on the OpenAlex side and eighteen further targeted web searches were logged.

### c236
**00_executive_summary.md** — 02_tango/v0.1 · q001;q014

(backed by query cells `q001`-`q014`) **Nothing in the corpus reaches M4 or M5.** No source shows a system in routine use by people other than its authors, or an output that entered a real operational decision with third-party evidence. The 11 M3 rows are retrospective work against references the authors did not produce — a real reservoir [[doi:10.48550/arxiv.2605.15028]], named catalyst systems [[arxiv:2606.05050]], real crash-validation decks [[doi:10.5281/zenodo.22554152]], a hand-written expert implementation [[doi:10.48550/arxiv.2607.15001]]. Several authors say so in their own terms: "an early exploration rather than a production-ready solution" [[doi:10.1080/19401493.2026.2653969]]; "early experience, not a controlled productivity benchmark" [[doi:10.20944/preprints202608.1323.v1]].

### c237
**03_touchpoints.md** — 02_tango/v0.1 · q007;q008;q009;q010
...
### c238
**04_evaluation.md** — 02_tango/v0.1 · q001;q006;q011;q014
...
### c239
**05_maturity.md** — 02_tango/v0.1 · q001;q014
...
### c073
**not stated** — 01_landscape/v0.5 · doi:10.3997/2214-4609.202535040
...
### c077
**not stated** — 01_landscape/v0.5 · doi:10.3997/2214-4609.202639012

not available - abstract only

### c078
**not stated** — 01_landscape/v0.5 · doi:10.3997/2214-4609.2025640024

Future work aims to validate across diverse geological settings
...
### c121
**Agentic Optimizer** — 02_tango/v0.1 · doi:10.5281/zenodo.20109894
...
### c126
**RASER** — 02_tango/v0.1 · arxiv:2609.03598

the authors state that traditional HPC job schedulers such as Slurm are not designed for dynamic, agentic workflows

### c127
**VicenteMartinez2026-conversational-dt** — 02_tango/v0.1 · doi:10.3390/electronics15091869
...
### c128
**Kalinin2026-dual-digital-twins** — 02_tango/v0.1 · doi:10.26434/chemrxiv.15005632/v1
...
### c129
**Shikalgar2026-urban-mobility-dt** — 02_tango/v0.1 · title:intelligentdigitaltwinsystemforurbanmobility
...
### c130
**Goyal2026-agentic-dt-survey** — 02_tango/v0.1 · doi:10.1109/mcomstd.2026.3669229

the paper carries an explicit limitations section, unread because the full text is blocked

### c131
**Wan2026-pde-llm-review** — 02_tango/v0.1 · arxiv:2608.03600
...
### c132
**Chatar2026-drilling-language-ai** — 02_tango/v0.1 · doi:10.2118/230773-ms
...
### c133
**DTAI** — 02_tango/v0.1 · doi:10.1109/ticps.2026.3665499
...
### c137
**RUNSPEC** — 02_tango/v0.1 · title:runspecspectreaiagenticgenerationanditerationofopmflowreservoirsimulationdecks

the vendor states that full-field history matching with 200 wells still needs other solutions

### c138
**SimAgent** — 02_tango/v0.1 · doi:10.1145/3731599.3767349

the authors state it still requires tailoring of the tool call setup depending on the tasks and computing platforms, and name reducing user interaction with Parsl, function environment management, logging and checkpointing, and asynchronous execution as future work

### c139
**Pham2026-multi-agent-mof-screening** — 02_tango/v0.1 · doi:10.48550/arxiv.2604.07681
...
### c140
**CFD-copilot** — 02_tango/v0.1 · doi:10.48550/arxiv.2512.07917
...
### c141
**PDE-Agents** — 02_tango/v0.1 · doi:10.48550/arxiv.2606.07850
...
### c142
**APS-Agent** — 02_tango/v0.1 · doi:10.1016/j.dche.2026.100312
...
### c143
**DynaMate2** — 02_tango/v0.1 · doi:10.48550/arxiv.2605.20819
...
### c144
**KBase Research Agent** — 02_tango/v0.1 · doi:10.1145/3815572.3815744
...
### c145
**ALL-FEM** — 02_tango/v0.1 · doi:10.1016/j.cma.2026.118985
...
### c146
**PUR-1 GPT** — 02_tango/v0.1 · doi:10.25394/pgs.32118403
...
### c147
**Schafer2026-chemasim-process-agent** — 02_tango/v0.1 · doi:10.48550/arxiv.2603.12813
...
### c148
**WARA** — 02_tango/v0.1 · doi:10.48550/arxiv.2608.14573
...
### c149
**Foam-Agent** — 02_tango/v0.1 · doi:10.48550/arxiv.2509.18178
...
### c150
**PhyNiKCE** — 02_tango/v0.1 · arxiv:2602.11666
...
### c151
**GAIA** — 02_tango/v0.1 · doi:10.48550/arxiv.2511.03852
...
### c152
**Bhandari2026-local-agentic-dft-audit** — 02_tango/v0.1 · doi:10.48550/arxiv.2608.29665
...
### c153
**MetaOpenFOAM** — 02_tango/v0.1 · doi:10.2139/ssrn.4921381
...
### c154
**AutoB2G** — 02_tango/v0.1 · doi:10.48550/arxiv.2603.26005
...
### c155
**AI CFD Scientist** — 02_tango/v0.1 · doi:10.48550/arxiv.2605.06607
...
### c156
**Foam-Agent** — 02_tango/v0.1 · doi:10.48550/arxiv.2505.04997
...
### c157
**Xu2026-agentic-urban-digital-twins** — 02_tango/v0.1 · doi:10.1016/j.compenvurbsys.2026.102449
...
### c158
**VASPilot** — 02_tango/v0.1 · doi:10.48550/arxiv.2508.07035
...
### c159
**IteraSim RAG** — 02_tango/v0.1 · arxiv:2607.20346
...
### c160
**Agentic SWMM** — 02_tango/v0.1 · doi:10.31223/x5f47g
...
### c161
**Jadhav2024-llm-fem-truss-designer** — 02_tango/v0.1 · doi:10.1080/09544828.2026.2624356
...
### c162
**Jan2026-agentic-digital-twin-ATSC** — 02_tango/v0.1 · doi:10.48550/arxiv.2604.27753
...
### c163
**FoamPilot** — 02_tango/v0.1 · doi:10.48550/arxiv.2412.17146
...
### c164
**TO-Master** — 02_tango/v0.1 · arxiv:2607.01812
...
### c165
**OpenFOAMGPT** — 02_tango/v0.1 · doi:10.1063/5.0257555
...
### c166
**MatSciAgent** — 02_tango/v0.1 · doi:10.1038/s43246-025-00994-x
...
### c167
**El Agente Quntur** — 02_tango/v0.1 · doi:10.48550/arxiv.2602.04850
...
### c168
**Aether** — 02_tango/v0.1 · arxiv:2604.18233
...
### c169
**text2flowsheet** — 02_tango/v0.1 · doi:10.1039/d6dd00060f
...
### c170
**SwarmFoam** — 02_tango/v0.1 · doi:10.2139/ssrn.6074109
...
### c171
**PDEFlow** — 02_tango/v0.1 · arxiv:2607.05134
...
### c172
**TSAgent** — 02_tango/v0.1 · arxiv:2605.14154
...
### c173
**Engineering.ai** — 02_tango/v0.1 · doi:10.48550/arxiv.2511.00122
...
### c174
**DREAMS** — 02_tango/v0.1 · doi:10.48550/arxiv.2507.14267
...
### c175
**CFDagent** — 02_tango/v0.1 · doi:10.1063/5.0294696
...
### c176
**TopOptAgents** — 02_tango/v0.1 · arxiv:2605.23273
...
### c177
**GENIUS** — 02_tango/v0.1 · doi:10.48550/arxiv.2512.06404
...
### c178
**MASTER** — 02_tango/v0.1 · doi:10.48550/arxiv.2512.13930
...
### c179
**AtomisticSkills** — 02_tango/v0.1 · doi:10.48550/arxiv.2605.24002
...
### c180
**AutoDFT** — 02_tango/v0.1 · arxiv:2605.26179
...
### c181
**Petkovic2025-raspa-multiagent** — 02_tango/v0.1 · doi:10.48550/arxiv.2509.10210
...
### c182
**Academy** — 02_tango/v0.1 · doi:10.1109/ipdps65963.2026.00114
...
### c183
**MOOSEnger** — 02_tango/v0.1 · doi:10.48550/arxiv.2608.15881
...
### c184
**Battery-Sim-Agent** — 02_tango/v0.1 · doi:10.1145/3770855.3818856
...
### c185
**LARA-HPC** — 02_tango/v0.1 · doi:10.48550/arxiv.2604.22571
...
### c186
**AutoSurrogate** — 02_tango/v0.1 · doi:10.48550/arxiv.2604.11945
...
### c187
**NAIS** — 02_tango/v0.1 · arxiv:2607.11084
...
### c188
**MatClaw** — 02_tango/v0.1 · arxiv:2604.02688
...
### c189
**pegasus-ai** — 02_tango/v0.1 · arxiv:2606.18425
...
### c190
**Masgent** — 02_tango/v0.1 · arxiv:2512.23010
...
### c191
**OpenFOAMGPT** — 02_tango/v0.1 · doi:10.1016/j.taml.2025.100623
...
### c192
**QUASAR** — 02_tango/v0.1 · doi:10.48550/arxiv.2602.00185
...
### c193
**El Agente Solido** — 02_tango/v0.1 · doi:10.48550/arxiv.2602.17886
...
### c194
**MooseAgent** — 02_tango/v0.1 · doi:10.48550/arxiv.2504.08621
...
### c195
**MDAgent** — 02_tango/v0.1 · doi:10.1038/s41598-025-92337-6
...
### c196
**FEABench** — 02_tango/v0.1 · doi:10.48550/arxiv.2504.06260
...
### c197
**TritonDFT** — 02_tango/v0.1 · doi:10.48550/arxiv.2603.03372
...
### c198
**MAPPS** — 02_tango/v0.1 · doi:10.48550/arxiv.2506.05616
...
### c199
**LQCDMaster** — 02_tango/v0.1 · doi:10.48550/arxiv.2607.15001
...
### c200
**MADE** — 02_tango/v0.1 · doi:10.48550/arxiv.2601.20996
...
### c201
**R-LAM** — 02_tango/v0.1 · doi:10.48550/arxiv.2601.09749
...
### c202
**Tan2026-aspen-reasoning-agent** — 02_tango/v0.1 · doi:10.1038/s44172-025-00583-3
...
### c203
**Laub2026-text2flowsheet-pipeline** — 02_tango/v0.1 · doi:10.69997/pse.120458
...
### c204
**Sakhinana2024-rait** — 02_tango/v0.1 · doi:10.48550/arxiv.2408.15866
...
### c205
**OpenFOAMGPT** — 02_tango/v0.1 · doi:10.1016/j.ijheatfluidflow.2026.110399
...
### c206
**Sedova2026-olcf-ai-coding-agents** — 02_tango/v0.1 · doi:10.20944/preprints202608.1323.v1
...
### c207
**NL2FOAM** — 02_tango/v0.1 · doi:10.1016/j.taml.2025.100594
...
### c208
**OptMetaOpenFOAM** — 02_tango/v0.1 · doi:10.1016/j.taml.2026.100660

there is no limitations section; the only limitation stated in the authors own terms is that the propagation distance is confined between 0 and 0.0707 by the physics of the case, so "owing to these inherent bounds, the fitted response surface is not perfect"

### c209
**OASiS** — 02_tango/v0.1 · doi:10.5281/zenodo.20543501
...
### c210
**M.A.R.V.I.N.** — 02_tango/v0.1 · doi:10.5281/zenodo.19835550
...
### c211
**CFDLLMBench** — 02_tango/v0.1 · doi:10.48550/arxiv.2509.20374
...
### c212
**ChatCFD** — 02_tango/v0.1 · doi:10.1002/aidi.202500174
...
### c213
**URSA LAMMPS agent** — 02_tango/v0.1 · doi:10.48550/arxiv.2607.22596
...
### c214
**NeuroClaw** — 02_tango/v0.1 · arxiv:2604.24696
...
### c215
**CatDT** — 02_tango/v0.1 · arxiv:2606.05050
...
### c216
**Xiao2026-openfoam-coding-agent** — 02_tango/v0.1 · arxiv:2602.11689
...
### c217
**Corridor** — 02_tango/v0.1 · doi:10.5281/zenodo.22554152
...
### c218
**DDA** — 02_tango/v0.1 · doi:10.3389/fchem.2026.1914886
...
### c219
**LLeM** — 02_tango/v0.1 · doi:10.1109/access.2025.3605803
...
### c220
**Grid-Mind** — 02_tango/v0.1 · arxiv:2602.20683
...
### c221
**Aspen-MCP** — 02_tango/v0.1 · title:aspenplusmcpanmcpserveroftypedschemaconstrainedtoolsovertheaspenpluscomapi
...
### c222
**MCP Solver** — 02_tango/v0.1 · title:mcpsolvermodelcontextprotocolserverforconstraintsolvingsatmaxsatsmtcpaspdp
...
### c223
**Onishi2026-reservoir-simulation-assistant** — 02_tango/v0.1 · title:247simulationloopshowagenticaikeepssubsurfaceengineeringmoving
...
### c224
**Zhang2025-llm-planning-bem-workflow** — 02_tango/v0.1 · title:automaticbuildingenergymodeldevelopmentanddebuggingusinglargelanguagemodelsagenticworkflow
...
### c225
**Agents4GEOS** — 02_tango/v0.1 · arxiv:2607.18557
...
### c226
**EnergyPlus-MCP** — 02_tango/v0.1 · doi:10.1016/j.softx.2025.102367
...
### c227
**Eppy-LLM** — 02_tango/v0.1 · doi:10.26868/30680611.2026.1305
...
### c228
**Chen2026-mcp-bem-paradigms** — 02_tango/v0.1 · doi:10.1080/19401493.2026.2653969
...
### c229
**GPT+MCP framework** — 02_tango/v0.1 · doi:10.3390/buildings15173190
...
### c230
**EngiAI** — 02_tango/v0.1 · doi:10.3929/ethz-c-000801434
...
### c231
**PetroGraph** — 02_tango/v0.1 · doi:10.48550/arxiv.2605.15028
...
### c232
**Carbonati2026-multi-agent-llm-acquisition** — 02_tango/v0.1 · doi:10.25417/uic.32994011.v1
...
### c233
**GAGAW** — 02_tango/v0.1 · doi:10.1016/j.bdes.2026.100042
...
### c234
**TanabeSugano** — 02_tango/v0.1 · doi:10.26434/chemrxiv.15007941/v1
...
Evaluation demonstrates M1; the source asserts: "Our implementation enables the LLM agent to access any compatible computing resource through Parsl."
...
### c260
**aihydro-tools** — 02_tango/v0.1 · doi:10.5281/zenodo.19597589
...
Evaluation demonstrates M1; the source asserts: "This work establishes a reproducible framework for trustworthy AI-assisted analysis in engineering, offering a scalable foundation for future developments in optimisation and regulatory automation."
...
### c101
**baseline** — 01_landscape/v0.5 · papers.csv (tier core) · 5/38

5 of 38 deep-read systems compared against no baseline.

### c102
**held_out** — 01_landscape/v0.5 · papers.csv (tier core) · 27/38

27 of 38 deep-read systems report no held-out evaluation.

### c103
**data_type** — 01_landscape/v0.5 · papers.csv (tier core) · 9/38

9 of 38 deep-read systems were evaluated on synthetic data only.

### c104
**maturity_ceiling** — 01_landscape/v0.5 · papers.csv (tier core) · 14/38

14 of 38 deep-read systems demonstrate M1 or below; 13 reach M3 or above.

### c252
**baseline** — 02_tango/v0.1 · papers.csv (tier core) · 12/98

12 of 98 deep-read systems compared against no baseline.

### c253
**held_out** — 02_tango/v0.1 · papers.csv (tier core) · 78/98

78 of 98 deep-read systems report no held-out evaluation.

### c254
**data_type** — 02_tango/v0.1 · papers.csv (tier core) · 28/98

28 of 98 deep-read systems were evaluated on synthetic data only.

### c255
**maturity_ceiling** — 02_tango/v0.1 · papers.csv (tier core) · 40/98

40 of 98 deep-read systems demonstrate M1 or below; 11 reach M3 or above.
...
### c096
**data_type** — 01_landscape/v0.5 · papers.csv · 59/151

59 of 151 admitted sources state nothing for `data_type`.
...
### c242
**base_model** — 02_tango/v0.1 · papers.csv · 81/183

81 of 183 admitted sources state nothing for `base_model`.

### c243
**tools_used** — 02_tango/v0.1 · papers.csv · 3/183

3 of 183 admitted sources state nothing for `tools_used`.

### c244
**evaluation_method** — 02_tango/v0.1 · papers.csv · 2/183

2 of 183 admitted sources state nothing for `evaluation_method`.

### c245
**baseline** — 02_tango/v0.1 · papers.csv · 49/183

49 of 183 admitted sources state nothing for `baseline`.

### c246
**held_out** — 02_tango/v0.1 · papers.csv · 112/183

112 of 183 admitted sources state nothing for `held_out`.

### c247
**data_type** — 02_tango/v0.1 · papers.csv · 71/183

71 of 183 admitted sources state nothing for `data_type`.

### c248
**reported_result** — 02_tango/v0.1 · papers.csv · 64/183

64 of 183 admitted sources state nothing for `reported_result`.

### c249
**maturity_claimed** — 02_tango/v0.1 · papers.csv · 27/183

27 of 183 admitted sources state nothing for `maturity_claimed`.

### c250
**author_stated_limitations** — 02_tango/v0.1 · papers.csv · 69/183

69 of 183 admitted sources state nothing for `author_stated_limitations`.

### c251
**code_availability** — 02_tango/v0.1 · papers.csv · 111/183

111 of 183 admitted sources state nothing for `code_availability`.


## unread-source — 33

### c120
**abstract_only** — 01_landscape/v0.5 · papers.csv · 113/151

113 of 151 admitted sources were never read beyond an abstract, so nothing in them contributes to any characterisation.

### c295
**abstract_only** — 02_tango/v0.1 · papers.csv · 85/183

85 of 183 admitted sources were never read beyond an abstract, so nothing in them contributes to any characterisation.

### c296
**doi:10.2118/229629-ms** — 02_tango/v0.1 · paywalled.md
...
### c297
**doi:10.2118/229905-ms** — 02_tango/v0.1 · paywalled.md
...
### c298
**doi:10.2118/232332-ms** — 02_tango/v0.1 · paywalled.md
...
### c299
**doi:10.2118/230773-ms** — 02_tango/v0.1 · paywalled.md
...
### c300
**doi:10.1063/5.0330986** — 02_tango/v0.1 · paywalled.md
...
### c301
**doi:10.1109/tii.2026.3669495** — 02_tango/v0.1 · paywalled.md
...
### c302
**doi:10.1109/icept67137.2025.11157286** — 02_tango/v0.1 · paywalled.md
...
### c303
**doi:10.1109/e-cargo65996.2025.11139170** — 02_tango/v0.1 · paywalled.md

nothing — a review, already `context`

### c304
**doi:10.1109/etfa65518.2025.11205636** — 02_tango/v0.1 · paywalled.md
...
### c305
**doi:10.1109/mcomstd.2026.3669229** — 02_tango/v0.1 · paywalled.md
...
### c306
**doi:10.1109/sci68648.2025.11333875** — 02_tango/v0.1 · paywalled.md

nothing — admitted `context` under the HPC-operations rule, and reading it would not move it to `core`

### c307
**doi:10.1109/ticps.2026.3665499** — 02_tango/v0.1 · paywalled.md
...
### c308
**doi:10.3997/2214-4609.202639027** — 02_tango/v0.1 · paywalled.md
...
### c309
**doi:10.3997/2214-4609.202637165** — 02_tango/v0.1 · paywalled.md
...
### c310
**doi:10.3997/2214-4609.2024637030** — 02_tango/v0.1 · paywalled.md

little — a one-paragraph conference abstract proposing a framework; it would stay `context`

### c311
**doi:10.3778/j.issn.1673-9418.2508051** — 02_tango/v0.1 · paywalled.md
...
### c312
**doi:10.26434/chemrxiv.15006587/v1** — 02_tango/v0.1 · paywalled.md

little, uniquely — the authors' repository was readable and is admitted `core` under the same `system_id`, so the system itself is in the grid. The preprint would add the peer-review-facing framing and nothing the repository does not already evidence

### c313
**doi:10.6084/m9.figshare.30931802** — 02_tango/v0.1 · paywalled.md
...
### c314
**title:agenticaienabled…** — 02_tango/v0.1 · paywalled.md
...
### c315
**doi:10.1016/j.net.2026.104573** — 02_tango/v0.1 · paywalled.md
...
### c316
**doi:10.26434/chemrxiv-2025-f1wcr** — 02_tango/v0.1 · paywalled.md
...
### c317
**doi:10.26434/chemrxiv.15005838/v1** — 02_tango/v0.1 · paywalled.md
...
### c318
**doi:10.1016/j.jma.2025.08.021** — 02_tango/v0.1 · paywalled.md
...
### c319
**doi:10.5281/zenodo.20388035** — 02_tango/v0.1 · paywalled.md
...
### c320
**doi:10.2139/ssrn.6672588** — 02_tango/v0.1 · paywalled.md
...
### c321
**doi:10.1145/3785462.3815873** — 02_tango/v0.1 · paywalled.md
...
### c322
**doi:10.26434/chemrxiv.15002405/v1** — 02_tango/v0.1 · paywalled.md
...
### c323
**doi:10.26434/chemrxiv.15007941/v1** — 02_tango/v0.1 · paywalled.md
...
### c324
**doi:10.2139/ssrn.6942178** — 02_tango/v0.1 · paywalled.md
...
### c325
**doi:10.1039/d5dd00435g** — 02_tango/v0.1 · paywalled.md

**everything.** This is the only admitted source of which *no* narrative text could be retrieved by any route — the single publisher-deposited sentence names no engine, so `tango_touchpoints` is recorded as `none` and every other field as `not stated`. It is the one row in the grid that is empty for want of access rather than for want of an author statement

### c326
**doi:10.2139/ssrn.7333555** — 02_tango/v0.1 · paywalled.md

everything. Like the row above, this record is empty rather than negative: the title names geometry abstraction and multi-agent parameter inference for urban building energy models, which would be `topology-construction` and `config-generation` evidence, but not one word of it can be quoted
